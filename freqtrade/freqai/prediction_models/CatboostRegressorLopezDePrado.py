...
class CatboostRegressorLopezDePrado(BaseRegressionModel, LopezDePradoMixin):
    """
    ...
    def fit(self, data_dictionary: dict, dk: FreqaiDataKitchen, **kwargs) -> Any:
        ...
        if not self._should_use_ensemble(config):
            logger.info("Training single CatBoost regressor (purged CV disabled)")
        ...
        self._log_ensemble_complete(fold_scores, "CatBoost regressor")
